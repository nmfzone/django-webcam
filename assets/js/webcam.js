...
window.webcam = {
	...
	swf_url: `${env.appURL}${env.staticAssetsLocation}/webcam.swf`, // URI to webcam.swf movie (defaults to cwd)
	shutter_url: `${env.appURL}${env.staticAssetsLocation}/shutter.mp3`, // URI to shutter.mp3 sound
